...
<html>
    ...
    <body>
         <nav class="navbar navbar-inverse navbar-fixed-top" id="navbar-inverse" style="background-color: white;">
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav" style="color: black;">
                    ...
                    <li class="pull-right"><a href="#">Logged in as <b class="user" style="margin-left:5px"><?php echo $user; ?></b></a></li>
