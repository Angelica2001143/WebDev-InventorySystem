<?php
    ...
    $isadmin=$thisUser['is_admin']==0?"where archive='0'":"";
    $sql= "SELECT * from products  $isadmin";
    $res= $conn->query($sql);
?>
        ...
        <div class="row" style="padding: 50px;">
            <div class="leftcolumn">
                <div class="card ">
                    ...
                    <div class="table_container" style="background-color: grey;">
                                    ...
                                    <?php
                                        if(mysqli_num_rows($res)>0){
                                            while($row= mysqli_fetch_assoc($res)){
                                                ...
                                                echo "<tr>";
                                                echo "<td style='color:white;background-color:gray'>".$row['name']."</td>";

                                                echo "<td style='color:white;background-color:gray'>".$row['bought']."</td>";

                                                echo "<td style='color:white;background-color:gray'>".$row['sold']."</td>";

                                                echo "<td style='color:white;background-color:gray'>".$stock."</td>";

                                                echo "<td style:'background-color:grey'><a href='viewProduct.php?id=".$row['id']."' class='btn btn-success btn-sm'>".
                                                ...
                                                echo "<a class='btn btn-primary' data-toggle='modal'data-target='#addProduct' class='btn btn-warning '>".
